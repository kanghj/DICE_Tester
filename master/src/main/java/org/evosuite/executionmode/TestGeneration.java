...
//		LoggingUtils.getEvoLogger().info("* Search budget on master -c " + Properties.SEARCH_BUDGET);
...
//		}
        ...
        LoggingUtils.getEvoLogger().info("* Search budget on master -b " + Properties.SEARCH_BUDGET);
		...
		LoggingUtils.getEvoLogger().info("* Search budget on master -a " + Properties.SEARCH_BUDGET);
